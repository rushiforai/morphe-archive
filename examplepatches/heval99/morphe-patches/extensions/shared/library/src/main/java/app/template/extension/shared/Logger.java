package app.template.extension.shared;

import static app.template.extension.shared.settings.BaseSettings.DEBUG;
import static app.template.extension.shared.settings.BaseSettings.DEBUG_STACKTRACE;
import static app.template.extension.shared.settings.BaseSettings.DEBUG_TOAST_ON_ERROR;
...
import app.template.extension.shared.settings.preference.LogBufferManager;
