package app.template.extension.shared.checks;

import static app.template.extension.shared.StringRef.str;
import static app.template.extension.shared.checks.Check.debugAlwaysShowWarning;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_BOARD;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_BOOTLOADER;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_BRAND;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI2;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_DEVICE;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_DISPLAY;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_FINGERPRINT;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_HARDWARE;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_HOST;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_ID;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_MANUFACTURER;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_MODEL;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_PRODUCT;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_RADIO;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_TAGS;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_TYPE;
import static app.template.extension.shared.checks.PatchInfo.Build.PATCH_USER;
