package app.template.extension.shared.settings.search;

import static app.template.extension.shared.StringRef.str;
import static app.template.extension.shared.Utils.getResourceIdentifierOrThrow;
...
import app.template.extension.shared.ResourceType;
import app.template.extension.shared.Utils;
import app.template.extension.shared.settings.AppLanguage;
import app.template.extension.shared.settings.BaseSettings;
import app.template.extension.shared.settings.Setting;
import app.template.extension.shared.settings.preference.ColorPickerPreference;
import app.template.extension.shared.settings.preference.CustomDialogListPreference;
import app.template.extension.shared.settings.preference.NoTitlePreferenceCategory;
import app.template.extension.shared.ui.Dim;
