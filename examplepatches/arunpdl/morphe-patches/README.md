...
> **[v1.0.5](https://github.com/arunpdl/morphe-patches/releases/tag/v1.0.5)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;8 patches total
<details open>
...
```
https://github.com/arunpdl/morphe-patches
```
