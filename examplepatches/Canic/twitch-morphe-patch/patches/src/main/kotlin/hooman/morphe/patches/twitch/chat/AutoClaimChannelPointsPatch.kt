...
val autoClaimChannelPointsPatch = bytecodePatch(
    ...
    execute {
        ...
        // provider it already holds (field m, vj8.H(claimId, ChatModeMetadata)) before building the
        ...
        method.addInstructionsWithLabels(
            0,
            """
                iget-object v0, p1, Lag8;->d:Lib;
                if-eqz v0, :skip
                iget-object v1, v0, Lib;->a:Ljava/lang/String;
                iget-object v2, p0, Lng8;->m:Lvj8;
                const/4 v3, 0x0
                invoke-interface {v2, v1, v3}, Lvj8;->H(Ljava/lang/String;Ltv/twitch/android/shared/one/chat/pub/ChatModeMetadata;)V
            """,
