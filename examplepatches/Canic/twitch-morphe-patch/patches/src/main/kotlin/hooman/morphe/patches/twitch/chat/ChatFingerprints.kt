...
// The community-points button state provider (ng8 = CommunityPointsButtonStateProvider in 30.5.0). U2(state)
...
// provider that performs the claim (field m, type vj8, exposing H(claimId, ChatModeMetadata)). R8
