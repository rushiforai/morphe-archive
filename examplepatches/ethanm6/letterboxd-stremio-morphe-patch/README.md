...
All four are on by default and can be toggled independently.
...
5. Patch the Letterboxd APK, selecting whichever of the four patches above you want enabled.

## Compatibility

This repo covers the Stremio button and Letterboxd's own promotional surfaces (Video Store banner/carousel, Where to Watch row, Spotlight ad card). It doesn't touch Letterboxd's AdMob banner/interstitial ads or the locked alternate app icons — for those, add [De-Vanced](https://github.com/RookieEnough/De-Vanced) as a second patch source in Morphe Manager alongside this one. Tested and confirmed working together.
