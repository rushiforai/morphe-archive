...
// Both processed resources and the source archive read files generated by
// prepareGxIconPack. Gradle 9+ requires these producer/consumer relationships
// to be explicit rather than relying on task execution order.
tasks.matching { it.name == "processResources" || it.name == "sourcesJar" }.configureEach {
...
patches {
    about {
        ...
        description = "Morphe patches for Pixilart ad removal, Suno timestamped-lyrics export and independently selectable app-name/custom-icon branding, a standalone Opera GX launcher icon selector, Opera GX raw mod downloads, and a cloneable Chrome Android Material You userscript manager with a Violentmonkey-derived parser and Greasy Fork/Sleazy Fork support."
