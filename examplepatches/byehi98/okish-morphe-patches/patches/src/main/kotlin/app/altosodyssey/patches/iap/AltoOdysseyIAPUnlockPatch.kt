package app.altosodyssey.patches.iap

import app.morphe.patcher.extensions.InstructionExtensions.addInstructions
import app.morphe.patcher.patch.bytecodePatch
import app.altosodyssey.patches.shared.Constants.COMPATIBILITY_ALTOSODYSSEY
import app.altosodyssey.patches.shared.Constants.SKUS
...
@Suppress("unused")
val altoOdysseyIAPUnlockPatch = bytecodePatch(
    name = "IAP Unlock",
    description = "Unlocks all in-app purchases in Alto's Odyssey by faking Google Play billing query results.",
    default = true
) {
    compatibleWith(COMPATIBILITY_ALTOSODYSSEY)
