...
package app.morphe.extension.prathxmpatches.patches.scrobbling.lastfm;
...
import app.morphe.extension.prathxmpatches.patches.scrobbling.ScrobbleManager;
        ...
        ScrobbleManager.getInstance().runOnBackgroundThread(() -> {
            try {
                ...
                if (ex.getErrorCode() == 9) {
                    ...
                    app.morphe.extension.prathxmpatches.settings.Settings.LASTFM_SESSION_KEY.resetToDefault();
                    app.morphe.extension.prathxmpatches.settings.Settings.LASTFM_USERNAME.resetToDefault();
                }
            } catch (Exception ex) {
