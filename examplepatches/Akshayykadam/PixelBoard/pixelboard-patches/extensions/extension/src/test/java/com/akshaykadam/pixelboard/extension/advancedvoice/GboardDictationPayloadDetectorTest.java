...
public final class GboardDictationPayloadDetectorTest {
    private static final String CUSTOM_PACKAGE =
    ...
    public void detectsPayloadFusedIntoBaseApk() throws Exception {
        ...
        assertEquals(CUSTOM_PACKAGE, detection.getPackageName());
    }
    ...
    @Test
    public void absentPayloadDetectedWhenArchivesAreReadable() throws Exception {
        File baseApk = createArchive("base-empty.apk", "assets/base.txt");
    ...
    @Test
    public void emptyArchiveListYieldsUnknownStatus() {
        GboardDictationPayloadDetector.Detection detection =
                GboardDictationPayloadDetector.inspectPackageArchives(
                        OFFICIAL_PACKAGE,
