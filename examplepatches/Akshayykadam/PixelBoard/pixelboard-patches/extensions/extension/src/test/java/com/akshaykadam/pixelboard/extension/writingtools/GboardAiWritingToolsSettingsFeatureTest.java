...
public final class GboardAiWritingToolsSettingsFeatureTest {
    ...
    public void buildScreenShowsExactlyMasterAllKeyboardsAndBackendRows() {
        ...
        Assert.assertEquals(
                "Show AI writing tools in the suggestion strip for instant proofreading, "
                        + "text rewriting, and smart suggestions. Restart Gboard to apply changes.",
                enabledRow.getSummary());
        Assert.assertEquals(
                "Enable AI Writing Tools across all language layouts and input fields without "
    ...
    private static final class CapturingHost extends com.akshaykadam.pixelboard.extension.settings.GboardPatchesSettingsTestHost {
        ...
        private CapturingHost(SharedPreferences preferences) {
            ...
            this.context = new ContextWrapper(null) {
                ...
                public String getPackageName() {
                    return "com.akshaykadam.pixelboard.test";
                }
            };
        }
