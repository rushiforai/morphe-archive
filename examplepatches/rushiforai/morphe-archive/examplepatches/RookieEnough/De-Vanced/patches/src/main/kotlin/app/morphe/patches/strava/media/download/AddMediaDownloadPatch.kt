/*
 * Forked from:
 * https://gitlab.com/ReVanced/revanced-patches/-/blob/main/patches/src/main/kotlin/app/revanced/patches/strava/media/download/AddMediaDownloadPatch.kt
 */
...
val addMediaDownloadPatch = bytecodePatch(
    ...
    execute {
        ...
        CreateAndShowFragmentFingerprint.match(fragmentClassDef).method.apply {
            ...
            val actionRegistrarRegister = this.getInstruction<BuilderInstruction22c>(setTrueIndex).registerB
        ...
        val actionClass = classDefBy(ACTION_CLASS_DESCRIPTOR)
