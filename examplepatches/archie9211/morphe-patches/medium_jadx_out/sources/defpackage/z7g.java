...
public final class z7g extends e3g implements RandomAccess {
    public static final Object[] d;
    public static final z7g e;
    public Object[] b;
    public int c;
    ...
    static {
        ...
        d = objArr;
        e = new z7g(objArr, 0, false);
    }

    public z7g(Object[] objArr, int i, boolean z) {
        super(z);
        this.b = objArr;
        this.c = i;
    }
    ...
    public final /* bridge */ /* synthetic */ q5g c(int i) {
        if (i >= this.c) {
            return new z7g(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
        lg8.r();
        return null;
    }
        ...
        if (obj instanceof List) {
            ...
            if (i == list.size()) {
                ...
                for (int i3 = 0; i3 < i; i3++) {
                    if (this.b[i3].equals(z7gVar.b[i3])) {
                    }
                }
                return true;
            }
