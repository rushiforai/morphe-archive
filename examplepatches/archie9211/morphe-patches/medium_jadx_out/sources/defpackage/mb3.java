...
public final class mb3 extends x0 implements yp8 {
    ...
    public mb3(Context context, Window window) {
        super(context, null);
        this.j = window;
        this.k = qo7.u(nz1.a);
        WeakHashMap weakHashMap = ute.a;
        mte.c(this, this);
        f4f.a(this, new st(this, 1));
    }
    ...
    public final z4f W(View view, z4f z4fVar) {
        if (!this.m) {
            ...
            if (iMax != 0 || iMax2 != 0 || iMax3 != 0 || iMax4 != 0) {
                return z4fVar.a.r(iMax, iMax2, iMax3, iMax4);
            }
        }
        return z4fVar;
    }
    ...
    public final void a(x12 x12Var, int i) {
        ...
        p65Var.a0(1735448596);
        int i2 = (p65Var.h(this) ? 4 : 2) | i;
        if (p65Var.P(i2 & 1, (i2 & 3) != 2)) {
            ((b55) this.k.getValue()).invoke(p65Var, 0);
        } else {
            p65Var.S();
        }
        mwa mwaVarS = p65Var.s();
        if (mwaVarS != null) {
            mwaVarS.d = new w0(this, i, 6);
        }
    }
    ...
    */
    public final void h(int r13, int r14) {
        ...
        Lb:
            ...
            r9 = 30
            if (r8 >= r9) goto L3b
            ty r8 = defpackage.ty.a
            int r8 = r8.a(r6)
            goto L4a
        L3b:
            r9 = 32
            if (r8 >= r9) goto L49
            vy r8 = defpackage.vy.a
            int r8 = r8.a(r6)
            goto L4a
        L46:
            int r8 = r3 + 1
        ...
        Lc7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mb3.h(int, int):void");
    }
}
