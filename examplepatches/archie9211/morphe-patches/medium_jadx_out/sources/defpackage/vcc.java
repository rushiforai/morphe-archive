...
public final class vcc extends Message.Builder {
    ...
    public final Message build() {
        return new SignUpSignInUnrecognizedEmailOtherSigninClicked(this.a, this.b, this.c, this.d, this.e, buildUnknownFields());
    }
}
