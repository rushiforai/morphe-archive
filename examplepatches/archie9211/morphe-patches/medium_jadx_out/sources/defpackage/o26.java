...
public final class o26 extends InputConnectionWrapper {
    public final /* synthetic */ f70 a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o26(InputConnection inputConnection, f70 f70Var) {
            ...
            try {
                ...
                try {
                    ...
                    if (uri != null && clipDescription != null) {
                        zJ = f70Var.j(new rz2(uri, clipDescription, uri2), i, bundle2);
                    }
                    if (resultReceiver != null) {
                        resultReceiver.send(zJ ? 1 : 0, null);
                    }
                } catch (Throwable th) {
                    th = th;
                    if (resultReceiver != null) {
