...
public final class f7a extends s75 {
    public static final f7a e;
    public static final vf6 f = new vf6(29);
    public final g21 a;
    public List b;
    public byte c;
    public int d;
    ...
    static {
        f7a f7aVar = new f7a();
        e = f7aVar;
        f7aVar.b = Collections.EMPTY_LIST;
    }

    public f7a(tp1 tp1Var, q74 q74Var) {
        this.c = (byte) -1;
        this.d = -1;
                ...
                try {
                    ...
                    if (iM != 0) {
                        if (iM == 10) {
                            ...
                            this.b.add(tp1Var.f(e7a.l, q74Var));
