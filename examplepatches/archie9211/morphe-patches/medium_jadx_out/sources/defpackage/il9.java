...
public final class il9 extends Message.Builder {
    public AnalyticsEventCommonFields a;
    public String b;
    public String c;
    public String d;
    public PostViewedContext e;
    public Boolean f;
    ...
    public final Message build() {
        return new PostRead(this.a, this.b, this.c, this.d, this.e, this.f, this.g, this.h, buildUnknownFields());
    }
}
