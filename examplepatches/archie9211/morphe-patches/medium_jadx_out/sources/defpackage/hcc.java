...
public final class hcc extends Message.Builder {
    ...
    public final Message build() {
        return new SignUpSignInRememberMeAccountHintViewed(this.a, this.b, this.c, this.d, this.e, buildUnknownFields());
    }
}
