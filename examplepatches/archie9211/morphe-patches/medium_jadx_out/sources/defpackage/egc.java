...
public final class egc {
    ...
    public final k65 a(int i) {
        ...
        int iC = hgc.c(arrayList, i, this.c);
        if (iC >= 0) {
    ...
    public final void e() {
        if (this.k == 0) {
            if (this.g != this.h) {
                b22.a("endGroup() not called at the end of a group");
            }
            int i = (this.i * 5) + 2;
            int[] iArr = this.b;
            int i2 = iArr[i];
    ...
    public final Object h(int i, int i2) {
        ...
        int i3 = i + 1;
        int i4 = iD + i2;
        return i4 < (i3 < this.c ? iArr[(i3 * 5) + 4] : this.e) ? this.d[i4] : w12.a;
    }
    ...
    public final Object n(int i) {
        ...
        if (i3 != 0) {
            return i3 != 0 ? this.d[iArr[i2 + 4]] : w12.a;
        }
        return null;
    }
    ...
    public final void r(int i) {
        if (this.k != 0) {
            b22.a("Cannot reposition while in an empty region");
        }
        this.g = i;
        int[] iArr = this.b;
        int i2 = this.c;
    ...
    public final int s() {
        if (this.k != 0) {
            b22.a("Cannot skip while in an empty region");
        }
        int i = this.g;
        int i2 = i * 5;
        int[] iArr = this.b;
    ...
    public final void t() {
        if (!(this.k == 0)) {
            b22.a("Cannot skip the enclosing group while in an empty region");
        }
        this.g = this.h;
        this.l = 0;
        this.m = 0;
    ...
    public final void u() {
        if (this.k <= 0) {
            ...
            int[] iArr = this.b;
            if (iArr[i3 + 2] != i) {
                xx9.a("Invalid slot table detected");
            }
            int i4 = this.l;
            int i5 = this.m;
            t46 t46Var = this.j;
