...
public final class u94 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float f4 = fArr[iMin];
        return lv8.e(fArr[iMin + 1], f4, f3, f4);
    }

    public u94(float[] fArr) {
        this.a = fArr;
