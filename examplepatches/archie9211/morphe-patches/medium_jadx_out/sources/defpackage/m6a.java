...
public final class m6a extends s75 {
    public static final m6a e;
    public static final vf6 f = new vf6(19);
    public final g21 a;
    public List b;
    public byte c;
    public int d;
    ...
    static {
        m6a m6aVar = new m6a();
        e = m6aVar;
        m6aVar.b = Collections.EMPTY_LIST;
    }

    public m6a(tp1 tp1Var, q74 q74Var) {
        this.c = (byte) -1;
        this.d = -1;
                ...
                try {
                    ...
                    if (iM != 0) {
                        if (iM == 10) {
                            ...
                            this.b.add(tp1Var.f(l6a.i, q74Var));
    ...
    public final boolean isInitialized() {
        ...
        for (int i = 0; i < this.b.size(); i++) {
            if (!((l6a) this.b.get(i)).isInitialized()) {
                this.c = (byte) 0;
                return false;
            }
        }
