...
public final class pk7 {
    ...
    public /* synthetic */ pk7(float[] fArr) {
        this.a = fArr;
    }
    ...
    public static final void c(float[] fArr, e78 e78Var) {
        if (fArr.length < 16) {
            return;
        }
        float f = fArr[0];
        ...
        e78Var.a = Math.min(f19, Math.min(f26, Math.min(f32, f37)));
        e78Var.b = Math.min(f22, Math.min(f28, Math.min(f34, f38)));
        e78Var.c = Math.max(f19, Math.max(f26, Math.max(f32, f37)));
        e78Var.d = Math.max(f22, Math.max(f28, Math.max(f34, f38)));
    }
    ...
    public static final void e(float[] fArr) {
        ...
        float fSin = (float) Math.sin(3.141592653589793d);
        float fCos = (float) Math.cos(3.141592653589793d);
        float f = fArr[1];
        float f2 = fArr[2];
        float f3 = (f * fCos) - (f2 * fSin);
        float f4 = fArr[5];
        float f5 = fArr[6];
        float f6 = (f4 * fCos) - (f5 * fSin);
        float f7 = fArr[9];
        float f8 = fArr[10];
        float f9 = (f7 * fCos) - (f8 * fSin);
        float f10 = fArr[13];
        float f11 = fArr[14];
        float f12 = (f10 * fCos) - (f11 * fSin);
        fArr[1] = f3;
        fArr[2] = (f2 * fCos) + (f * fSin);
        fArr[5] = f6;
        fArr[6] = (f5 * fCos) + (f4 * fSin);
        fArr[9] = f9;
        fArr[10] = (f8 * fCos) + (f7 * fSin);
        fArr[13] = f12;
        fArr[14] = (f11 * fCos) + (f10 * fSin);
    }
