...
public final class f62 {
    ...
    public final void a(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, xra.e);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (i2) {
                case 1:
                    this.p = j62.f(typedArrayObtainStyledAttributes, index, this.p);
                    break;
                case 2:
                    this.I = typedArrayObtainStyledAttributes.getDimensionPixelSize(index, this.I);
                    break;
                case 3:
                    this.o = j62.f(typedArrayObtainStyledAttributes, index, this.o);
                    break;
                case 4:
                    this.n = j62.f(typedArrayObtainStyledAttributes, index, this.n);
                    break;
                case 5:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    this.v = j62.f(typedArrayObtainStyledAttributes, index, this.v);
                    break;
                case 10:
                    this.u = j62.f(typedArrayObtainStyledAttributes, index, this.u);
                    break;
                case 11:
                ...
                case 23:
                    ...
                    break;
                case 24:
                    this.h = j62.f(typedArrayObtainStyledAttributes, index, this.h);
                    break;
                case 25:
                    this.i = j62.f(typedArrayObtainStyledAttributes, index, this.i);
                    break;
                case 26:
                ...
                case 27:
                    ...
                    break;
                case 28:
                    this.j = j62.f(typedArrayObtainStyledAttributes, index, this.j);
                    break;
                case 29:
                    this.k = j62.f(typedArrayObtainStyledAttributes, index, this.k);
                    break;
                case 30:
                    this.K = typedArrayObtainStyledAttributes.getDimensionPixelSize(index, this.K);
                    break;
                case 31:
                    this.s = j62.f(typedArrayObtainStyledAttributes, index, this.s);
                    break;
                case 32:
                    this.t = j62.f(typedArrayObtainStyledAttributes, index, this.t);
                    break;
                case 33:
                    this.H = typedArrayObtainStyledAttributes.getDimensionPixelSize(index, this.H);
                    break;
                case 34:
                    this.m = j62.f(typedArrayObtainStyledAttributes, index, this.m);
                    break;
                case 35:
                    this.l = j62.f(typedArrayObtainStyledAttributes, index, this.l);
                    break;
                case 36:
                ...
                case 40:
                    ...
                    break;
                case 41:
                    j62.g(this, typedArrayObtainStyledAttributes, index, 0);
                    break;
                case 42:
                    j62.g(this, typedArrayObtainStyledAttributes, index, 1);
                    break;
                default:
                    switch (i2) {
                        case 61:
                            this.z = j62.f(typedArrayObtainStyledAttributes, index, this.z);
                            break;
                        case 62:
                        ...
                        default:
                            switch (i2) {
                                ...
                                case PanasonicMakernoteDirectory.TAG_AF_POINT_POSITION /* 77 */:
                                    this.q = j62.f(typedArrayObtainStyledAttributes, index, this.q);
                                    break;
                                case 78:
                                    this.r = j62.f(typedArrayObtainStyledAttributes, index, this.r);
                                    break;
                                case 79:
