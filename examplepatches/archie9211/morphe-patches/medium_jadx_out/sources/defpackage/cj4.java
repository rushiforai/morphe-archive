...
public final class cj4 extends p4d implements c55 {
    public /* synthetic */ int b;
    public /* synthetic */ CreatorPreviewData c;
    public final /* synthetic */ fj4 d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public cj4(fj4 fj4Var, n92 n92Var) {
        super(3, n92Var);
        this.d = fj4Var;
    }
    ...
    public final Object f(Object obj, Object obj2, Object obj3) {
        ...
        cj4 cj4Var = new cj4(this.d, (n92) obj3);
        cj4Var.b = iIntValue;
        cj4Var.c = (CreatorPreviewData) obj2;
        return cj4Var.invokeSuspend(c1e.a);
    }

    @Override // defpackage.kn0
    public final Object invokeSuspend(Object obj) {
        int i = this.b;
        CreatorPreviewData creatorPreviewData = this.c;
        br7.v(obj);
        fj4 fj4Var = this.d;
        ConcurrentHashMap concurrentHashMap = fj4Var.m;
        String id = creatorPreviewData.getId();
        if (concurrentHashMap.get(id) == null) {
            concurrentHashMap.putIfAbsent(id, Boolean.valueOf(creatorPreviewData.getUserFollowData().getViewerEdge().isFollowing()));
        }
        kne kneVar = fj4Var.f;
        ine ineVar = ine.FOLLOW;
        SourceParameter sourceParameter = fj4Var.z;
