...
public final class wwa implements InputConnection {
    public final wjc a;
    ...
    public wwa(uid uidVar, wjc wjcVar, boolean z) {
        this.a = wjcVar;
        this.b = z;
        this.d = uidVar;
    }
    ...
    public final boolean b() {
        ...
        if (i == 0) {
            ...
            if (!arrayList.isEmpty()) {
                ((cjd) this.a.b).e.invoke(new ArrayList(arrayList));
                arrayList.clear();
            }
        }
        return this.c > 0;
    ...
    public final void closeConnection() {
        ...
        this.c = 0;
        this.h = false;
        ArrayList arrayList = ((cjd) this.a.b).i;
    ...
    public final CharSequence getSelectedText(int i) {
        ...
        return pr7.j(this.d).b;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextAfterCursor(int i, int i2) {
        return pr7.k(this.d, i).b;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextBeforeCursor(int i, int i2) {
        return pr7.l(this.d, i).b;
    }
    ...
    public final boolean performEditorAction(int i) {
        ...
        if (z) {
            ...
            if (i != 0) {
                ...
                ((cjd) this.a.b).f.invoke(new qy5(i2));
            } else {
                i2 = 1;
                ((cjd) this.a.b).f.invoke(new qy5(i2));
            }
    ...
    */
    public final boolean requestCursorUpdates(int r10) {
        ...
        L77:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wwa.requestCursorUpdates(int):boolean");
    }
    ...
    public final boolean sendKeyEvent(KeyEvent keyEvent) {
        ...
        ((BaseInputConnection) ((cjd) this.a.b).j.getValue()).sendKeyEvent(keyEvent);
        return true;
    }
