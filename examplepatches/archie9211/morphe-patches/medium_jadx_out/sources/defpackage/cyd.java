...
public final class cyd extends ReplacementSpan {
    public final byd b;
    public TextPaint e;
    ...
    public cyd(byd bydVar) {
        jq7.h("rasterizer cannot be null", bydVar);
        this.b = bydVar;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        ...
        L94:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cyd.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        byd bydVar = this.b;
        this.d = fAbs / (bydVar.b().a(14) != 0 ? ((ByteBuffer) r8.d).getShort(r1 + r8.a) : (short) 0);
        uz7 uz7VarB = bydVar.b();
        int iA = uz7VarB.a(14);
        if (iA != 0) {
            ((ByteBuffer) uz7VarB.d).getShort(iA + uz7VarB.a);
        }
        short s = (short) ((bydVar.b().a(12) != 0 ? ((ByteBuffer) r5.d).getShort(r7 + r5.a) : (short) 0) * this.d);
        this.c = s;
