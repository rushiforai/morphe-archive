...
public final class gp9 implements sh9 {
    public final /* synthetic */ ap9 a;

    public gp9(ap9 ap9Var) {
        this.a = ap9Var;
    }
    ...
    public final void C(String str, SourceParameter sourceParameter) {
        str.getClass();
        sourceParameter.getClass();
        throw new IllegalStateException("Following is not supported in this screen");
    }
    ...
    public final void E(String str, SourceParameter sourceParameter) {
        throw new IllegalStateException("Selecting collection is not supported in this screen");
    }
    ...
    public final void F(String str, SourceParameter sourceParameter) {
        str.getClass();
        sourceParameter.getClass();
        throw new IllegalStateException("Pinning is not supported in this screen");
    }
    ...
    public final void H(SourceParameter sourceParameter, String str, String str2) {
        ...
        str2.getClass();
        sourceParameter.getClass();
        throw new IllegalStateException("Muting is not supported in this screen");
    }
    ...
    public final void J(SourceParameter sourceParameter, String str, String str2) {
        str2.getClass();
        sourceParameter.getClass();
        throw new IllegalStateException("Reporting is not supported in this screen");
    }
    ...
    public final void b(SourceParameter sourceParameter, String str, String str2) {
        sourceParameter.getClass();
        throw new IllegalStateException("Featuring is not supported in this screen");
    }
    ...
    public final void e(String str, SourceParameter sourceParameter) {
        str.getClass();
        sourceParameter.getClass();
        throw new IllegalStateException("Show less like this is not supported in this screen");
    }
    ...
    public final void i(String str, SourceParameter sourceParameter) {
        str.getClass();
        sourceParameter.getClass();
        throw new IllegalStateException("Selecting author is not supported in this screen");
    }
    ...
    public final void s(String str, SourceParameter sourceParameter) {
        sourceParameter.getClass();
        throw new IllegalStateException("Bookmark is not supported in this screen");
    }
    ...
    public final void u(PostShareData postShareData, g08 g08Var) {
        ...
        g08Var.getClass();
        throw new IllegalStateException("Share is not supported in this screen");
    }
    ...
    public final void z(String str, SourceParameter sourceParameter) throws PendingIntent.CanceledException {
        str.getClass();
        sourceParameter.getClass();
        PostStatsFragment postStatsFragment = this.a.a;
        b09.O(postStatsFragment.Z(), postStatsFragment.S(), str, gp7.u(sourceParameter), null, null, null, 120);
    }
}
