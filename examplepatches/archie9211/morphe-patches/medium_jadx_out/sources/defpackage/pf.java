...
public final class pf extends p4d implements c55 {
    public /* synthetic */ int b;
    public /* synthetic */ FollowedTagsQuery.Tag c;
    public final /* synthetic */ qf d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public pf(qf qfVar, n92 n92Var) {
        super(3, n92Var);
        this.d = qfVar;
    }
    ...
    public final Object f(Object obj, Object obj2, Object obj3) {
        ...
        pf pfVar = new pf(this.d, (n92) obj3);
        pfVar.b = iIntValue;
        pfVar.c = (FollowedTagsQuery.Tag) obj2;
        return pfVar.invokeSuspend(c1e.a);
    }

    @Override // defpackage.kn0
    public final Object invokeSuspend(Object obj) {
        int i = this.b;
        FollowedTagsQuery.Tag tag = this.c;
        br7.v(obj);
        TagData tagData = tag.getTagData();
        qf qfVar = this.d;
        nec necVar = qfVar.e;
        zbd zbdVar = zbd.FOLLOW;
        SourceParameter sourceParameter = qfVar.l;
