...
public class SignatureCheck {
    ...
    private static String expectedLegacyUpgradedSignature = "mbmdhB/1KiYHPwOMdOtPevZISNlBxDnRjORMteHhxck=";
    private static String expectedSignature = "mbmdhB/1KiYHPwOMdOtPevZISNlBxDnRjORMteHhxck=";
    private static String expectedTestSignature = "mbmdhB/1KiYHPwOMdOtPevZISNlBxDnRjORMteHhxck=";
