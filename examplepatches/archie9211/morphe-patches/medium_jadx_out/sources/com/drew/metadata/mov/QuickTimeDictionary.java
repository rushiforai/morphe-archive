...
public class QuickTimeDictionary {
    private static final HashMap<String, String> _vendorIds;
    ...
    static {
        ...
        _videoCompressionTypes.put(HrUBqHumRuLe.uwiismW, "BMP");
        ...
        _videoCompressionTypes.put(bPUi.AyBfDXmmRGSq, "WaterRipple");
        _videoCompressionTypes.put("WRAW", JWcjNoweKCnTr.gaCbBpaWWm);
        ...
        _soundAudioFormats.put(uvlZTF.iJicoheFKtmWmo, "");
        ...
        _majorBrands.put(bPUi.mPFTrfhff, "3GPP Media (.3GP) Release 1 (probably non-existent)");
        ...
        _majorBrands.put(OphtYB.lGoSjeaVXlxnnv, "DMB MAF, extending dv1a, with 3GPP timed text, DID, TVA, REL, IPMP");
        ...
        _majorBrands.put(fiHTiFJ.kBoVZ, "MPEG-4 (.MP4) Nero Cinema Profile");
        ...
        _majorBrands.put("ROSS", PdtluglzAX.Baab);
        ...
        map.put(" KD ", "Kodak");
        map.put("AR.D", "Parrot AR.Drone");
        map.put("FFMP", "FFmpeg");
        map.put("GIC ", "General Imaging Co.");
        map.put("KMPI", "Konica-Minolta");
        map.put("NIKO", "Nikon");
        map.put("SMI ", "Sorenson Media Inc.");
        map.put("ZORA", "Zoran Corporation");
        map.put("appl", "Apple");
        map.put("fe20", "Olympus (fe20)");
        map.put("kdak", "Kodak");
        map.put("leic", "Leica");
        map.put("mino", "Minolta");
        map.put("niko", "Nikon");
        map.put("olym", "Olympus");
        map.put("pana", "Panasonic");
        map.put("pent", "Pentax");
        map.put("pr01", "Olympus (pr01)");
        map.put("sany", "Sanyo");
    }
}
