...
public class Mp4Dictionary {
    ...
    static {
        ...
        _dictionary.put(Integer.valueOf(Mp4VideoDirectory.TAG_COMPRESSION_TYPE), _videoCompressionTypes);
        _dictionary.put(301, _soundAudioFormats);
        _dictionary.put(Integer.valueOf(Mp4VideoDirectory.TAG_VENDOR), _vendorIds);
        ...
        _videoCompressionTypes.put("mx3n", ezwlgQm.cLgdRJs);
        ...
        _majorBrands.put(VrhD.fyzX, "DMB MAF, extending da1a, with 3GPP timed text, DID, TVA, REL, IPMP");
        ...
        _majorBrands.put("NDXP", ziYqbdHrAXvj.zpxVawYdqE);
        ...
        _vendorIds.put(PqkdNGCEoxOKZk.iXhCudGawYeqt, "Nikon");
