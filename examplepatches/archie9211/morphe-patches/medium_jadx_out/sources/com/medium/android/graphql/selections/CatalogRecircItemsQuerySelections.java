...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\n\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\u0007R\u001a\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\u0007R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\n\u0010\u0007R\u001a\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\u0007R\u001d\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006¢\u0006\f\n\u0004\b\f\u0010\u0007\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"Lcom/medium/android/graphql/selections/CatalogRecircItemsQuerySelections;", "", "<init>", "()V", "", "Lsx1;", "__creator", "Ljava/util/List;", "__items", "__itemsConnection", "__onCatalog", "__catalogById", "__root", "get__root", "()Ljava/util/List;", "graphql"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class CatalogRecircItemsQuerySelections {
    public static final CatalogRecircItemsQuerySelections INSTANCE = new CatalogRecircItemsQuerySelections();
    ...
    static {
        ...
        List<sx1> listR2 = d46.R(nx1Var3, y30.c(list, "CatalogItemV2", listQ, list), new nx1("catalogItemId", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var));
        __items = listR2;
        nx1 nx1Var4 = new nx1("__typename", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var);
        CatalogItemV2.INSTANCE.getClass();
        List<sx1> listR3 = d46.R(nx1Var4, new nx1("items", new rx1(new px1(kyd.b(CatalogItemV2.type))), null, ey3Var, ey3Var, listR2));
        __itemsConnection = listR3;
        nx1 nx1Var5 = new nx1("id", y30.e(GraphQLID.INSTANCE), null, ey3Var, ey3Var, ey3Var);
        nx1 nx1Var6 = new nx1("name", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var);
        nx1 nx1Var7 = new nx1("creator", y30.g(User.INSTANCE), null, ey3Var, ey3Var, listR);
        ...
        mx1Var.getClass();
        nx1 nx1Var8 = new nx1("itemsConnection", rx1VarB, null, ey3Var, ka1.y(mx1Var, new yv8(new tx1("pagingOptions"))), listR3);
        PredefinedCatalogType.INSTANCE.getClass();
        n04 n04Var = PredefinedCatalogType.type;
        n04Var.getClass();
        List<sx1> listR4 = d46.R(nx1Var5, nx1Var6, nx1Var7, nx1Var8, new nx1("predefined", n04Var, null, ey3Var, ey3Var, ey3Var));
        __onCatalog = listR4;
    ...
    private CatalogRecircItemsQuerySelections() {
    }
