...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u000b\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\u0007R\u001a\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\u0007R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\n\u0010\u0007R\u001a\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\u0007R\u001a\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\f\u0010\u0007R\u001d\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006¢\u0006\f\n\u0004\b\r\u0010\u0007\u001a\u0004\b\u000e\u0010\u000f¨\u0006\u0010"}, d2 = {"Lcom/medium/android/graphql/selections/PublicationArchiveQuerySelections;", "", "<init>", "()V", "", "Lsx1;", "__node", "Ljava/util/List;", "__edges", "__pageInfo", "__onRelayPublicationPostConnection", "__publicationPostsConnection", "__publication", "__root", "get__root", "()Ljava/util/List;", "graphql"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class PublicationArchiveQuerySelections {
    public static final PublicationArchiveQuerySelections INSTANCE = new PublicationArchiveQuerySelections();
    private static final List<sx1> __edges;
    private static final List<sx1> __node;
    private static final List<sx1> __onRelayPublicationPostConnection;
    ...
    static {
        ...
        List<sx1> listR4 = d46.R(new nx1("edges", new rx1(kyd.a(RelayPublicationPostEdge.type)), null, ey3Var, ey3Var, listR2), new nx1("pageInfo", km4.r(PageInfoV2.INSTANCE), null, ey3Var, ey3Var, listR3));
        __onRelayPublicationPostConnection = listR4;
        List<sx1> listR5 = d46.R(new nx1("__typename", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var), new ox1("RelayPublicationPostConnection", d46.Q("RelayPublicationPostConnection"), listR4));
        __publicationPostsConnection = listR5;
        ...
        List<sx1> listR6 = d46.R(nx1Var3, new nx1("publicationPostsConnection", rx1VarB, null, ey3Var, d46.R(lx1Var, lx1Var2, lx1Var3, new lx1(mx1Var4, new yv8(ka1.d(mx1Var4, "orderBy")))), listR5), new nx1("id", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var));
        __publication = listR6;
        sm8 sm8Var = Publication.type;
        sm8Var.getClass();
        Query.INSTANCE.getClass();
        mx1 mx1Var5 = Query.__publication_id;
        mx1Var5.getClass();
        __root = d46.Q(new nx1("publication", sm8Var, null, ey3Var, ka1.y(mx1Var5, new yv8(new tx1("publicationId"))), listR6));
    }

    private PublicationArchiveQuerySelections() {
    }
