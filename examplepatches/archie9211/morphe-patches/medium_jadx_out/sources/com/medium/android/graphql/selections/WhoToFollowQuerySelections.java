...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\t\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\u0007R\u001a\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\u0007R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\n\u0010\u0007R\u001d\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006¢\u0006\f\n\u0004\b\u000b\u0010\u0007\u001a\u0004\b\f\u0010\r¨\u0006\u000e"}, d2 = {"Lcom/medium/android/graphql/selections/WhoToFollowQuerySelections;", "", "<init>", "()V", "", "Lsx1;", "__node", "Ljava/util/List;", "__edges", "__pageInfo", "__recommendedPublishers", "__root", "get__root", "()Ljava/util/List;", "graphql"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class WhoToFollowQuerySelections {
    public static final WhoToFollowQuerySelections INSTANCE = new WhoToFollowQuerySelections();
    ...
    static {
        ...
        List listR = d46.R("User", "Collection");
        List<sx1> list = WhoToFollowNodeSelections.INSTANCE.get__root();
        List<sx1> listR2 = d46.R(nx1Var, y30.c(list, "RecommendedPublishersConnectionEdgeNode", listR, list));
        __node = listR2;
        ...
        List<sx1> listR3 = d46.R(nx1Var2, new nx1("node", kyd.b(RecommendedPublishersConnectionEdgeNode.type), null, ey3Var, ey3Var, listR2));
        __edges = listR3;
        ...
        List<sx1> listR4 = d46.R(nx1Var3, y30.c(list2, "PageInfoV2", listQ, list2));
        __pageInfo = listR4;
        ...
        List<sx1> listR5 = d46.R(nx1Var4, new nx1("edges", new rx1(new px1(kyd.b(RecommendedPublishersConnectionEdge.type))), null, ey3Var, ey3Var, listR3), new nx1("pageInfo", km4.r(PageInfoV2.INSTANCE), null, ey3Var, ey3Var, listR4));
        __recommendedPublishers = listR5;
        ...
        lx1 lx1Var3 = new lx1(mx1Var3, new yv8(ka1.d(mx1Var3, "mode")));
        mx1 mx1Var4 = Query.__recommendedPublishers_tagSlug;
        __root = d46.Q(new nx1("recommendedPublishers", rx1VarB, null, ey3Var, d46.R(lx1Var, lx1Var2, lx1Var3, new lx1(mx1Var4, new yv8(ka1.d(mx1Var4, "tagSlug")))), listR5));
    }

    private WhoToFollowQuerySelections() {
    }
