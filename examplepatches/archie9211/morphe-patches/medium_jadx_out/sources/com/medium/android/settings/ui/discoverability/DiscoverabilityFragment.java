package com.medium.android.settings.ui.discoverability;
...
public final class DiscoverabilityFragment extends km5 {
    ...
    public static final /* data */ class BundleInfo extends AbstractMediumFragment.BundleInfo {
        ...
        public String toString() {
            return ev6.x("BundleInfo(referrerSource=", this.referrerSource, gYpYQDQkhfs.tuMvNdCSwsCtb);
        }
    }

    public DiscoverabilityFragment() {
        super(16);
        this.u0 = vx0.d0(yw6.NONE, new nh2(13, this));
    }
    ...
    public final View B(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        composeView.setContent(new mz1(new if3(this, 0), true, -329761441));
        return composeView;
    }
}
