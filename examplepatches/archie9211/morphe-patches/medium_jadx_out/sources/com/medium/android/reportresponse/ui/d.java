...
public final class d extends p4d implements b55 {
    ...
    public d(a7b a7bVar, n92 n92Var) {
        super(2, n92Var);
        this.c = a7bVar;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((d) create((sb2) obj, (n92) obj2)).invokeSuspend(c1e.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            br7.v(obj);
            gg5 gg5Var = a7bVar.f;
            String responseId = ((ReportResponseReference.Catalog) reportResponseReference).getResponseId();
            String catalogId = ((ReportResponseReference.Catalog) reportResponseReference).getCatalogId();
            String str = a7bVar.d;
            String str2 = a7bVar.n;
            String str3 = a7bVar.m;
            this.b = 1;
            objJ = gg5Var.J(catalogId, responseId, str, str2, str3, this);
            if (objJ == tb2Var) {
                return tb2Var;
            }
        } else {
