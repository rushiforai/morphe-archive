...
public final class WelcomeFragment extends pn5 {
    ...
    public WelcomeFragment() {
        super(7);
        this.v0 = vx0.d0(yw6.NONE, new l2f(0, this));
    }
    ...
    public final View B(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        composeView.setContent(new mz1(new k2f(this, 0), true, -1368157978));
        return composeView;
    }
}
