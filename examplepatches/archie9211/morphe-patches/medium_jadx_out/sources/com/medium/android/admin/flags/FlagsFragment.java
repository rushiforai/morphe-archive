...
public final class FlagsFragment extends km5 {
    ...
    public FlagsFragment() {
        super(24);
        this.u0 = vx0.d0(yw6.NONE, new em4(0, this));
    }
    ...
    public final View B(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        lig ligVar = new lig(this, S(), false, 29);
        ComposeView composeView = new ComposeView(S(), null, 6);
        composeView.setViewCompositionStrategy(zi5.h);
        composeView.setContent(new mz1(new fm4(this, ligVar, 0), true, -1462311095));
        return composeView;
    }
}
