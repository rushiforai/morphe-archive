...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\b\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\u0007R\u001a\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\u0007R\u001d\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006¢\u0006\f\n\u0004\b\n\u0010\u0007\u001a\u0004\b\u000b\u0010\f¨\u0006\r"}, d2 = {"Lcom/medium/android/graphql/selections/UndoRepostPostMutationSelections;", "", "<init>", "()V", "", "Lsx1;", "__onPost", "Ljava/util/List;", "__onRepostError", "__undoRepost", "__root", "get__root", "()Ljava/util/List;", "graphql"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class UndoRepostPostMutationSelections {
    public static final UndoRepostPostMutationSelections INSTANCE = new UndoRepostPostMutationSelections();
    private static final List<sx1> __onPost;
    private static final List<sx1> __onRepostError;
    private static final List<sx1> __root;
    private static final List<sx1> __undoRepost;
    ...
    static {
        ...
        List<sx1> listR2 = d46.R(new nx1("__typename", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var), new ox1("Post", d46.Q("Post"), listR), new ox1("RepostError", d46.Q("RepostError"), listQ3));
        __undoRepost = listR2;
        RepostResult.INSTANCE.getClass();
        b1e b1eVar = RepostResult.type;
        b1eVar.getClass();
        Mutation.INSTANCE.getClass();
        mx1 mx1Var = Mutation.__undoRepost_targetPostId;
        mx1Var.getClass();
        __root = d46.Q(new nx1("undoRepost", b1eVar, null, ey3Var, ka1.y(mx1Var, new yv8(new tx1("targetPostId"))), listR2));
    }

    private UndoRepostPostMutationSelections() {
    }
