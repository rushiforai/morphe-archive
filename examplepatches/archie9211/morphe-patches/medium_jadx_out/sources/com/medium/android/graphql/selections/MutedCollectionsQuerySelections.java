...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u000b\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\u0007R\u001a\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\u0007R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\n\u0010\u0007R\u001a\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\u0007R\u001a\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\f\u0010\u0007R\u001d\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006¢\u0006\f\n\u0004\b\r\u0010\u0007\u001a\u0004\b\u000e\u0010\u000f¨\u0006\u0010"}, d2 = {"Lcom/medium/android/graphql/selections/MutedCollectionsQuerySelections;", "", "<init>", "()V", "", "Lsx1;", "__collections", "Ljava/util/List;", "__next", "__pagingInfo", "__mutedCollectionConnection", "__onUser", "__user", "__root", "get__root", "()Ljava/util/List;", "graphql"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class MutedCollectionsQuerySelections {
    public static final MutedCollectionsQuerySelections INSTANCE = new MutedCollectionsQuerySelections();
    ...
    private MutedCollectionsQuerySelections() {
    }
    ...
    static {
        ...
        List<sx1> list = CollectionPreviewDataSelections.INSTANCE.get__root();
        List<sx1> listR = d46.R(nx1Var, y30.c(list, "Collection", listQ, list), new nx1("id", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var));
        __collections = listR;
        ...
        List<sx1> listR4 = d46.R(nx1Var3, new nx1("collections", new rx1(new px1(kyd.b(Collection.type))), null, ey3Var, ey3Var, listR), new nx1(ivbZv.DmMLGdWcDJuDe, km4.v(Paging.INSTANCE), null, ey3Var, ey3Var, listR3));
        __mutedCollectionConnection = listR4;
        CollectionConnection.INSTANCE.getClass();
        sm8 sm8Var = CollectionConnection.type;
        sm8Var.getClass();
        User.INSTANCE.getClass();
        mx1 mx1Var = User.__mutedCollectionConnection_paging;
        mx1Var.getClass();
        List<sx1> listQ3 = d46.Q(new nx1("mutedCollectionConnection", sm8Var, null, ey3Var, ka1.y(mx1Var, new yv8(new tx1("paging"))), listR4));
        __onUser = listQ3;
        List<sx1> listR5 = d46.R(new nx1("__typename", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var), new ox1("User", d46.Q("User"), listQ3), new nx1("id", kyd.b(GraphQLString.type), null, ey3Var, ey3Var, ey3Var));
        __user = listR5;
