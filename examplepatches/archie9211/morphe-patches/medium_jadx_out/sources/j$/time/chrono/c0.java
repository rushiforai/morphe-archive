...
public final class c0 extends d {
    ...
    */
    public final j$.time.chrono.c0 b(long r8, j$.time.temporal.n r10) {
        /*
            r7 = this;
        ...
        La3:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.c0.b(long, j$.time.temporal.n):j$.time.chrono.c0");
    }

    public final c0 H(LocalDate localDate) {
    ...
    @Override // j$.time.chrono.d, j$.time.chrono.b
    public final m v() {
        return F() >= 1 ? d0.ROC : d0.BEFORE_ROC;
    }

    @Override // j$.time.chrono.d, j$.time.chrono.b
    public final b x(TemporalAmount temporalAmount) {
        return (c0) super.x(temporalAmount);
    }
