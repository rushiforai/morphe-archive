...
public final class t5 extends x {
    public final /* synthetic */ long l;
    public final /* synthetic */ long m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public t5(z zVar, int i, long j, long j2) {
        super(zVar, i);
        this.l = j;
        this.m = j2;
    }
    ...
    public final g2 K(a aVar, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jG > 0 && spliterator.hasCharacteristics(OlympusMakernoteDirectory.TAG_MAIN_INFO)) {
            ...
            return v3.B(aVar, v3.Y(aVar2.I(), spliterator, this.l, this.m), true);
        }
        if (y6.ORDERED.k(aVar.f)) {
            return (g2) new v5(this, aVar, spliterator, intFunction, this.l, this.m).invoke();
        }
        j$.util.r0 r0Var = (j$.util.r0) aVar.T(spliterator);
        long j2 = this.l;
        long j3 = this.m;
        if (j2 <= jG) {
            long j4 = jG - j2;
        ...
        return v3.B(this, new u7(r0Var, j, jMin), true);
    }
    ...
    public final Spliterator L(a aVar, Spliterator spliterator) {
        ...
        if (jG > 0 && spliterator.hasCharacteristics(OlympusMakernoteDirectory.TAG_MAIN_INFO)) {
            j$.util.r0 r0Var = (j$.util.r0) aVar.T(spliterator);
            long j = this.l;
            return new o7(r0Var, j, v3.z(j, this.m));
        }
        if (y6.ORDERED.k(aVar.f)) {
            return ((g2) new v5(this, aVar, spliterator, new u1(12), this.l, this.m).invoke()).spliterator();
        }
        j$.util.r0 r0Var2 = (j$.util.r0) aVar.T(spliterator);
        long j2 = this.l;
        long jMin = this.m;
        if (j2 <= jG) {
            long j3 = jG - j2;
