...
public final class f6 extends g1 implements m8 {
    ...
    public Spliterator L(a aVar, Spliterator spliterator) {
        switch (this.l) {
            case 1:
                return y6.ORDERED.k(aVar.f) ? K(aVar, spliterator, new u1(17)).spliterator() : new s8((j$.util.x0) aVar.T(spliterator), 1);
            case 2:
                return y6.ORDERED.k(aVar.f) ? K(aVar, spliterator, new u1(18)).spliterator() : new s8((j$.util.x0) aVar.T(spliterator), 0);
            default:
    ...
    public final l5 N(int i, l5 l5Var) {
        switch (this.l) {
            case 0:
                ...
                return y6.SIZED.k(i) ? new k6(l5Var) : new c6(l5Var);
            case 1:
