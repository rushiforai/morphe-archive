...
/**
 * Smali bytecode that uses reflection to find the MaxRewardedAdListener field
 * on `this` (MaxRewardedAd), then fires:
 * onAdDisplayed -> onRewardedVideoStarted -> onUserRewarded -> onRewardedVideoCompleted -> onAdHidden.
 */
