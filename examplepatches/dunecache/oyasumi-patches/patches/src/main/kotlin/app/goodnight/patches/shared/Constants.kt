package app.goodnight.patches.shared
...
object Constants {
    ...
    // (recommendation, not enforced). Target 1.345.0 / version code 634 only.
    val COMPATIBILITY_GOODNIGHT = Compatibility(
        name = "Goodnight",
        packageName = "com.one.goodnight",
