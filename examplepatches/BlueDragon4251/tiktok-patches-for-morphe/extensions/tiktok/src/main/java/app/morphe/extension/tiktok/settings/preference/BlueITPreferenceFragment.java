...
public class BlueITPreferenceFragment extends AbstractPreferenceFragment {
    private static final int REQUEST_DOWNLOAD_PATH_FOLDER = 8841;
    private static final String ARG_SECTION = "blueit_service_settings_section";
    private static BlueITPreferenceFragment activeFragment;
    ...
    private void createMasterMenu(Context context, PreferenceScreen screen) {
        ...
        screen.addPreference(new BlueITCreditsPreference(context));
    }
    ...
    private void openSection(Section section) {
        ...
        BlueITPreferenceFragment fragment = new BlueITPreferenceFragment();
