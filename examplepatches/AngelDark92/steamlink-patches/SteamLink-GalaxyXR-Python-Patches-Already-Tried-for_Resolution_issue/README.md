...
The experiment copies all rendered video projections, including foveal alpha, into Android Surface swapchains. It targets exact 2.0.20/5001712 and a further exact 2.0.22 build, but this report does not establish a separate headset failure on each base. The exact tested APK, Surface precision and runtime activation/fallback state were not verified.
