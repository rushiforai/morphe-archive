...
import app.jouss.patches.trackit.shared.Constants.COMPATIBILITY_TRACKIT
        ...
        EntitlementInfosMapFingerprint.method.apply {
            findInstructionIndicesReversedOrThrow(Opcode.RETURN_OBJECT).forEach { index ->
                ...
                addInstructions(index, """
                    invoke-static {v$register}, Lapp/jouss/extension/trackit/EntitlementMapPatch;->injectEntitlement(Ljava/util/Map;)Ljava/util/Map;
