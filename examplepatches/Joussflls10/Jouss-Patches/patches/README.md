...
> [!NOTE]
> 🚀 **All patch requests, feature updates, and announcements are now handled through [Issues](https://gitlab.com/Joussflls10/Jouss-Patches/-/issues).** Subscribe to stay updated!
>
> - **New app requests** → [Open Request](https://gitlab.com/Joussflls10/Jouss-Patches/-/issues/new)
> - **Bug reports & enhancements** → [Open Issue](https://gitlab.com/Joussflls10/Jouss-Patches/-/issues)
> - **Updates & announcements** → [Releases](https://gitlab.com/Joussflls10/Jouss-Patches/-/releases)

![Pipeline Status](https://gitlab.com/Joussflls10/Jouss-Patches/badges/main/pipeline.svg)
![Latest Release](https://gitlab.com/Joussflls10/Jouss-Patches/-/badges/release.svg)
![License](https://img.shields.io/badge/License-GPL%20v3-yellow.svg)

Custom [Morphe](https://morphe.software) patches for unlocking premium features in Android apps.

## Patches

<!-- PATCHES_START EXPANDED -->
> **[v1.19.0](https://github.com/Joussflls10/Jouss-Patches/releases/tag/v1.19.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;57 patches total
<details open>
...
[![Add to Morphe Manager](https://img.shields.io/badge/Add%20to-Morphe%20Manager-blue?style=for-the-badge)](https://morphe.software/add-source?gitlab=Joussflls10/Jouss-Patches)

1. Install [Morphe Manager](https://morphe.software) on your Android device
2. Click the badge above or add `https://gitlab.com/Joussflls10/Jouss-Patches` as a patch source
...
Want a new app patched? [Open a patch request](https://gitlab.com/Joussflls10/Jouss-Patches/-/issues/new?issuable_template=Patch%20Request).

> **Note:** Not all apps can be patched. Server-side features (AI, cloud sync, server-validated subscriptions) cannot be bypassed.

## Report a Bug

Found an issue with an existing patch? [Open a bug report](https://gitlab.com/Joussflls10/Jouss-Patches/-/issues/new?issuable_template=bug-report).
...
Use the tested versions shown in the table above. Download the correct format (XAPK/APKM) and architecture (arm64 for modern phones).

#### The patch doesn't work on a newer version
Open a [bug report](https://gitlab.com/Joussflls10/Jouss-Patches/-/issues/new?issuable_template=bug-report) with the app version and error message.
...
> - If you are a developer or rights holder and believe this project infringes on your rights, please [submit a takedown request](https://gitlab.com/Joussflls10/Jouss-Patches/-/issues/new?issuable_template=takedown-request) and the relevant patches will be **promptly removed**.
