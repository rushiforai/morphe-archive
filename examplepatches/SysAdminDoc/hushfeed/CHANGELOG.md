...
* **TikTok:** Hide comment popup ads now stops the brand animation itself. On 47.0.3 it only turned off TikTok's analytics report about the animation, so the animation still played. TikTok's own celebration when you post a video's first comment still plays. It was checked against TikTok's code and on a phone, but not with a real campaign. Tell us if one still plays for you.
