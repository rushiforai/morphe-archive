    ...
    public void addPreferences(Context context) {
        ...
        if (SettingsStatus.regionSpoofEnabled) {
            addPreference(new TogglePreference(context, "Match locale and timezone to country",
                    "Also change the region TikTok reports internally. Keeps your interface language. Needs Override SIM details. Your IP address and your account's own rules still apply.", Settings.REGION_SPOOF));
            addPreference(new TogglePreference(context, "Override store region (experimental)",
                    "Use the preset for the region TikTok reports for your account and its shop too. May affect search. Needs Override SIM details and Match locale and timezone to country.", Settings.REGION_STORE_SPOOF));
        }
