...
import app.revanced.patches.kakaotalk.layout.chatroom.fingerprints.ChatRoomProfileEditBindFingerprint
import app.revanced.patches.kakaotalk.layout.chatroom.fingerprints.ChatRoomSetIdFingerprint
import app.revanced.patches.kakaotalk.layout.chatroom.fingerprints.ChatRoomSideInitFingerprint
import app.revanced.patches.kakaotalk.layout.chatroom.fingerprints.ChatRoomSideTitleItemLambdaFingerprint
...
private fun BytecodePatchContext.addChatRoomSettingsChannelId() {
    ...
    val bindMethod = ChatRoomProfileEditBindFingerprint.method.cloneParameters()
    ...
    bindMethod.addInstructions(
        ...
        """
            ...
            invoke-static/range {p0 .. p1}, ${bindMethod.definingClass}->$BIND_CHANNEL_ID_METHOD(Landroid/view/View;$chatRoomType)V
        """.trimIndent(),
    )
}
