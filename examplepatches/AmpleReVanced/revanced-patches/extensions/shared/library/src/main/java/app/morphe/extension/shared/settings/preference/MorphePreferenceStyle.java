...
public final class MorphePreferenceStyle {
    ...
    public static void syncIconSlot(View view) {
        ...
        iconView.setVisibility(drawable == null ? View.GONE : View.VISIBLE);
        if (drawable != null) {
    ...
    public static void syncPreferenceScreenRow(View view) {
        ...
        boolean hasSummary = summary != null
                && summary.getVisibility() == View.VISIBLE
                && !TextUtils.isEmpty(summary.getText());
        row.setHasSummary(hasSummary);
    }
    ...
    public static void applyListStyle(ListView listView) {
        ...
        listView.setPadding(0, dp(context, 10), 0, dp(context, 10));
    ...
    private static PreferenceRow findPreferenceRow(View view) {
        ...
        for (int i = 0; i < group.getChildCount(); i++) {
            PreferenceRow row = findPreferenceRow(group.getChildAt(i));
            if (row != null) {
                return row;
            }
        }
