...
The addon option helper and extracted language rail changed in 0.9; fingerprints now identify their new structural signatures. The native Subtitle model adds stream ownership and request headers. SDH detection and marking rules are unchanged. This compartment owns the translated switch label and description.
