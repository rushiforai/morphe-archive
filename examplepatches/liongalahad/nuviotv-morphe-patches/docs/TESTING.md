...
2. Application: hash the official APK, build `.mpp`, select one patch in exclusive mode, and require all fingerprints to resolve once on all four declared variants: x86_64, universal, arm64-v8a and armeabi-v7a.
...
- [NuvioTV 0.9.0-beta runtime and automated validation](../testing/VALIDATION_0.9.0-beta.md).
- [1.0.0-beta.1 public release and Android Manager validation](../validation/1.0.0-beta.1-manager.md).

These reports distinguish emulator coverage from outstanding physical-TV acceptance.
