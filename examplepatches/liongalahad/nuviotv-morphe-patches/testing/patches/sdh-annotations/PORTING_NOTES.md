...
The 0.8.3-beta R8 target is matched through the Media3 interface/callback shape, the sidecar renderer shape and the settings resource/section-building sequence. Never widen a failed fingerprint. A new Nuvio version remains unsupported until isolated patching and every runtime gate pass.
