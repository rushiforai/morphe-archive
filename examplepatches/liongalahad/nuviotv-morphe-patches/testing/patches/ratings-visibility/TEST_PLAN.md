...
- [ ] Unit tests cover defaults, all stored modes, malformed values, and watched/unwatched decisions.
- [ ] Every fingerprint matches exactly once on every declared official asset.
- [ ] Exclusive patch application succeeds for universal, x86_64, arm64-v8a, and armeabi-v7a.
- [ ] Post-patch manifest and DEX inspection find only the Ratings category registration and required hooks.
