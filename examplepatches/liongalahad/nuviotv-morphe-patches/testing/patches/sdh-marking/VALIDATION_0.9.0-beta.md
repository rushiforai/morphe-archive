...
- All seven TV AVDs passed the setting toggle.
- Live addon and imported SRT rows displayed English SDH for the marked fixture.
- Detection algorithms remain covered by the extension tests; settings catalogs cover ten locales.
