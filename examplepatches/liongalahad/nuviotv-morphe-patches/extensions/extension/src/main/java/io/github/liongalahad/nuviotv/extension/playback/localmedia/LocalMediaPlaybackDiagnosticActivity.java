...
/** Temporary tester-facing diagnostics for device-specific Library > Storage playback failures. */
public final class LocalMediaPlaybackDiagnosticActivity extends Activity {
    private static final String PREFS = "morphe_patches";
    private static final String REPORT_KEY = "debug.local_media.playback_report";
    ...
    static void arm(Context context, String origin, String mediaUri, String route, Object controller) {
        ...
        armedReport = header(context, "LM-PLAYBACK") +
                "\nOrigin: " + safe(origin) +
                "\n" + uriDetails +
    ...
    static void report(Context context, String stage, Throwable error) {
        String report = (armedReport == null ? header(context, "LM-PLAYBACK") : armedReport) +
                "\n\nStage: " + safe(stage) + "\n\n" + stackTrace(error);
    ...
    private static void show(Context context, String report) {
        Intent intent = new Intent(context, LocalMediaPlaybackDiagnosticActivity.class)
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        card.setBackground(LocalMediaTvUi.shape(
                LocalMediaTvUi.CARD, dp(18), dp(1), Color.rgb(90, 90, 90)));
        outer.addView(card, new LinearLayout.LayoutParams(dp(760), dp(520)));

        TextView title = LocalMediaTvUi.text(this, 24, LocalMediaTvUi.TEXT_PRIMARY);
        title.setText("Playback diagnostic");
        card.addView(title, new LinearLayout.LayoutParams(-1, -2));

        TextView instruction = LocalMediaTvUi.text(this, 17, LocalMediaTvUi.TEXT_PRIMARY);
        ...
        TextView details = LocalMediaTvUi.text(this, 15, LocalMediaTvUi.TEXT_SECONDARY);
