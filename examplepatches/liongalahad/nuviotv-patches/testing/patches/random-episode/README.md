...
The original Random Episode settings and feature implementation were created by [**DeclanSC**](https://github.com/DeclanSC). This Morphe patch ports that work to NuvioTV 0.8.3-beta's current binary structure.
