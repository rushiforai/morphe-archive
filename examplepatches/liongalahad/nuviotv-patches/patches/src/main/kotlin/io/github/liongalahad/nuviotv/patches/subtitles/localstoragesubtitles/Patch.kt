...
val localstoragesubtitlesPatch = bytecodePatch(
    ...
    description = "Adds Local Storage to Nuvio's ExoPlayer subtitle menu and imports subtitle files from the device.",
    default = false
) {
    compatibleWith(NUVIO_COMPATIBILITY)
        ...
        RestoreTrackPreferencesFingerprint.method.apply {
            ...
            addInstructionsWithLabels(
                ...
                """
                    ...
                    iget-object v1, v4, ${seasonField.descriptor()}
                    iget-object v2, v4, ${episodeField.descriptor()}
                    invoke-static { v0, v1, v2 }, $RUNTIME->restoredSubtitle(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;)Ljava/lang/Object;
                    move-result-object v3
                    if-eqz v3, :morphe_local_restore_active_check
                    check-cast v3, $SUBTITLE
                    move-object/from16 v0, p0
                    invoke-static { v0, v3 }, ${selectMethod.descriptor()}
                    return-void
                    :morphe_local_restore_active_check
                    nop
                    invoke-static {}, $RUNTIME->shouldSuppressTrackPreferenceRestore()Z
                    move-result v0
