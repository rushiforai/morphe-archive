...
# Obfuscated-Gboard-shaped literals: a single package segment of a few lowercase letters, R8's
# output shape. Longer chains (Ljava/util/List;, Lapp/morphe/...;) and our own classes
# (Ldev/jz6/...) are excluded by the segment rule itself.
CLASS_REF = re.compile(r"^L[a-z]{2,6};$")
MEMBER_REF = re.compile(r"^L[a-z]{2,6};->")
