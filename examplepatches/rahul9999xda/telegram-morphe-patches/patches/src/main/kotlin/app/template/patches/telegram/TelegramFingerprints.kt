...
// ─── Rich Message forwarding ─────────────────────────────────────────────────
// Verified reference: Telegram Web 12.10.1 (70389).
// The third parameter is the forwarding-name flag (p4 in an instance method).
val SendMessagesHelperForwardMessagesFingerprint = Fingerprint(
    definingClass = "Lorg/telegram/messenger/SendMessagesHelper;",
    name = "sendMessage",
    returnType = "I",
    parameters = listOf(
