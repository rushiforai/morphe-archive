...
/**
 * Compile-time stub for androidx.media3.common.AdPlaybackState.
 *
 * This class is present in the patched app's DEX (classes.dex) and is
 * referenced by SkipAdsPatch.java. The stub provides just enough surface
 * for javac to resolve the types and method signatures used in the extension.
 *
