...
Ad blocking, dark mode, price history charts, Rufus tab removal, and sort by number
of ratings for Amazon Shopping.
...
| Sort by number of ratings | ❌ | Adds a "Sort: Most rated" button on search/listing pages; re-orders loaded results by ratings count, descending |
