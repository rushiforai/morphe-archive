...
/**
 * `w98.o0.a(Context, String, k): i` — the URL-scheme handler that owns LINE's entire
 ...
 *
 * Note: the disable injection returns `Lv98/i;->b:Lv98/i$a;` (the existing "not handled"
