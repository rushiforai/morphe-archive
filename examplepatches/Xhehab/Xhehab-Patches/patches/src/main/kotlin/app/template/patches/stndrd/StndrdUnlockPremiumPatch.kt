...
import app.template.patches.shared.Constants.STNDRD_COMPATIBILITY
...
val stndrdUnlockPremiumPatch = bytecodePatch(
    ...
    execute {
        StndrdCustomerInfoMapFingerprint
            .match(classDefBy(StndrdCustomerInfoMapFingerprint.definingClass!!))
            .method
            .apply {
                if (implementation == null) return@apply

                val returnIndex = instructions.indexOfLast { it.opcode.name.startsWith("return-object") }
                if (returnIndex < 0) error("STNDRD: CustomerInfo mapper return-object not found.")
                ...
                addInstructions(
                    ...
                    const-string v4, "2026-07-04T00:00:00.000Z"
                    invoke-interface {v1, v2, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
                    ...
                    const-string v4, "2035-07-04T00:00:00.000Z"
                    invoke-interface {v1, v2, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
                    ...
                    const-string v4, "annual_regular"
                    invoke-interface {v1, v2, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
                    ...
                    const-string v2, "2035-07-04T00:00:00.000Z"
                    invoke-interface {v0, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

                    new-instance v8, Ljava/util/ArrayList;
                    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V
                    const-string v1, "annual_regular"
                    invoke-interface {v8, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z
                    const-string v1, "monthly_regular"
                    invoke-interface {v8, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z
                    const-string v1, "stndrd_plus"
                    invoke-interface {v8, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z
