...
public final class GboardAccessibilityLayout1803Runtime {
    private GboardAccessibilityLayout1803Runtime() {
    }

    public static Object applyOverriddenFlagValue(String flagName, Object stockResult) {
        try {
            if (!GboardAccessibilityLayout1803Policy.PK_SIMULATOR_FLAG.equals(flagName)
    ...
    static Object applyOverriddenFlagValue(
        ...
        return GboardAccessibilityLayout1803Policy.maybeForce(
                flagName,
                stockResult,
