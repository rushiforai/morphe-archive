...
public final class GboardSettingsText {
    ...
    private static Map<Integer, String> createStableTraditionalChineseTemplates() {
        ...
        templates.put(R.string.gboard_patches_advanced_voice_section_offline_speech_model,
                "離線語音模型");
        templates.put(R.string.gboard_patches_advanced_voice_section_supported_languages,
                "支援的語言");
        templates.put(R.string.gboard_patches_advanced_voice_supported_languages_title,
                "支援的語言");
        templates.put(R.string.gboard_patches_advanced_voice_supported_languages_summary,
                "只有 en-US 可以支援完整功能\n\n"
                        + "英文 en-AU、en-CA、en-GB、en-IE、en-IN、en-SG、en-US\n"
                        + "德文 de-AT、de-BE、de-CH、de-DE\n"
                        + "法文 fr-BE、fr-CA、fr-CH、fr-FR\n"
                        + "義大利文 it-CH、it-IT\n日文 ja-JP\n西班牙文 es-ES、es-US");
        templates.put(R.string.gboard_patches_advanced_voice_github_star_title,
                "在 GitHub 上支持這個專案 😊");
        templates.put(R.string.gboard_patches_advanced_voice_github_star_summary,
                "這個功能投入了大量時間；如果對你有幫助，請到 GitHub 點個 Star。");
        templates.put(R.string.gboard_patches_advanced_voice_speech_services_present_title,
                "Speech Recognition & Synthesis（已安裝）");
        templates.put(R.string.gboard_patches_advanced_voice_speech_services_absent_title,
                "Speech Recognition & Synthesis（未安裝）");
        templates.put(R.string.gboard_patches_advanced_voice_speech_services_unknown_title,
                "Speech Recognition & Synthesis（無法確認）");
        templates.put(R.string.gboard_patches_advanced_voice_speech_services_status_summary,
                "套件：com.google.android.tts。啟用進階語音輸入的必要條件：必須安裝 Speech Recognition & Synthesis，"
                        + "並下載目前使用語言的離線語音辨識模型。點擊即可開啟 Google Play 頁面。");
        templates.put(R.string.gboard_patches_advanced_voice_downloaded_languages_title,
                "已下載的離線語言");
        templates.put(R.string.gboard_patches_advanced_voice_downloaded_languages_loading_summary,
                "正在讀取已下載的離線語言…");
        templates.put(R.string.gboard_patches_advanced_voice_downloaded_languages_empty_summary,
                "尚未偵測到已下載的離線語言。");
        templates.put(R.string.gboard_patches_advanced_voice_downloaded_languages_unsupported_summary,
                "這個 Android 版本不支援查詢已下載的離線語言。");
        templates.put(R.string.gboard_patches_advanced_voice_downloaded_languages_unavailable_summary,
                "找不到裝置端語音辨識服務。");
        templates.put(R.string.gboard_patches_advanced_voice_downloaded_languages_error_summary,
                "無法讀取已下載的離線語言，請在即時轉錄中確認。");
        templates.put(R.string.gboard_patches_advanced_voice_downloaded_languages_separator, "、");
        templates.put(R.string.gboard_patches_advanced_voice_live_transcribe_manage_title,
                "使用即時轉錄管理語言");
        templates.put(R.string.gboard_patches_advanced_voice_live_transcribe_manage_summary,
                "使用 Google 官方「即時轉錄」下載啟用進階語音輸入所需的 Speech Recognition & Synthesis "
                        + "離線語音辨識模型。請在即時轉錄中開啟：設定 → 更多設定 → 主要語言。\n"
                        + "點擊即可開啟即時轉錄。");
        templates.put(R.string.gboard_patches_advanced_voice_speech_services_open_failed,
                "無法開啟 Speech Recognition & Synthesis 的 Google Play 頁面。");
        templates.put(R.string.gboard_patches_advanced_voice_live_transcribe_open_failed,
                "無法開啟即時轉錄或其 Google Play 頁面。");
        templates.put(R.string.gboard_patches_advanced_voice_payload_present_title,
                "Dictation payload（已安裝）");
