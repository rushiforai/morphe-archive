...
public final class GboardBluetoothMicrophone1777Runtime {
    private static final String TAG = "GboardPatches";
    private static final String LOG_PREFIX = "[gboard-bluetooth-microphone-17.7.7] ";
    ...
    private GboardBluetoothMicrophone1777Runtime() {
    }
    ...
    private static Object applyOverriddenFlagValue(
        ...
        Object overridden = GboardBluetoothMicrophone1777Policy.maybeForce(
                flagName,
                stockResult,
                enabled);
    ...
    private static boolean isOverrideCandidate(String flagName, Object stockResult) {
        return GboardBluetoothMicrophone1777Policy.BLUETOOTH_MICROPHONE_FLAG.equals(flagName)
