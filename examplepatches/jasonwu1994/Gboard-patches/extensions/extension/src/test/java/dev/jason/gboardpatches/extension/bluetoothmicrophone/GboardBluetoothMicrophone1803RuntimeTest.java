...
public final class GboardBluetoothMicrophone1803RuntimeTest {
    ...
    public void seamForcesOnlyEnabledExactBooleanFalse() {
        ...
        Assert.assertEquals(Boolean.TRUE,
                GboardBluetoothMicrophone1803Runtime.applyOverriddenFlagValue(
                        new FirstReceiver("enable_use_bluetooth_setting"),
                        Boolean.FALSE,
                        enabledPreferences));
        ...
        Assert.assertSame(Boolean.FALSE,
                GboardBluetoothMicrophone1803Runtime.applyOverriddenFlagValue(
                        ...
                        Boolean.FALSE,
                        enabledPreferences));
        Assert.assertNull(GboardBluetoothMicrophone1803Runtime.applyOverriddenFlagValue(
                null,
                null,
                enabledPreferences));
    }
