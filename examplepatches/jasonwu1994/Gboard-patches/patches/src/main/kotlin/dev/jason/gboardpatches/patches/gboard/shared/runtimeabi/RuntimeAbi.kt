...
internal enum class RuntimeCallId(internal val encodedAbi: String) {
    ...
    MANUAL_INCOGNITO_RUNTIME_AFTER_CONTROLLER_CREATED("Ldev/jason/gboardpatches/extension/manualincognito/GboardManualIncognitoRuntime;->afterAccessPointControllerCreated(Ljava/lang/Object;Landroid/content/Context;)V"),
    ...
    MANUAL_INCOGNITO_RUNTIME_INCLUDE_ACCESS_POINT_CATALOG("Ldev/jason/gboardpatches/extension/manualincognito/GboardManualIncognitoRuntime;->includeAccessPointInOrderCatalog(Ljava/lang/Object;)Ljava/lang/Object;"),
    ...
    RAMBLER_RUNTIME_AFTER_NGA_ELIGIBILITY("Ldev/jason/gboardpatches/extension/rambler/GboardRambler1777Runtime;->afterNgaEligibility(Z)Z"),
    RAMBLER_RUNTIME_ENTER_LAUNCH_SCOPE("Ldev/jason/gboardpatches/extension/rambler/GboardRambler1777Runtime;->enterLaunchScope(Ljava/lang/Object;)V"),
    RAMBLER_RUNTIME_ENTER_PARSER_SCOPE("Ldev/jason/gboardpatches/extension/rambler/GboardRambler1777Runtime;->enterParserScope(Ljava/lang/Object;)V"),
    RAMBLER_RUNTIME_EXIT_LAUNCH_SCOPE("Ldev/jason/gboardpatches/extension/rambler/GboardRambler1777Runtime;->exitLaunchScope()V"),
    RAMBLER_RUNTIME_EXIT_PARSER_SCOPE("Ldev/jason/gboardpatches/extension/rambler/GboardRambler1777Runtime;->exitParserScope()V"),
    RAMBLER_RUNTIME_INJECT_JETSON_SESSION("Ldev/jason/gboardpatches/extension/rambler/GboardRambler1777Runtime;->injectJetsonSession(Ljava/lang/Object;)Ljava/lang/Object;"),
    RAMBLER_RUNTIME_TRY_INITIALIZE_STOCK_FALLBACK("Ldev/jason/gboardpatches/extension/rambler/GboardRambler1777Runtime;->tryInitializeStockFallback(Ljava/lang/Object;)Z"),
