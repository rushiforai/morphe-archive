 ...
 * @throws PatchException in this Transit-only fork, where resource mapping patches are removed.
...
fun Method.indexOfFirstResourceId(resourceName: String): Int {
    throw PatchException(
        "Resource mapping is not available in this Transit-only fork (resource: '$resourceName')."
    )
}
