...
patches {
    about {
        name = "dhl0 Morphe Patches"
        description = "Fork of Mix Patches with a Redgifs native playback fix for Sync for Reddit"
        source = "git@gitlab.com:dhl0/morphe-patches.git"
        author = "dhl0 (fork of IMXEren/mix-patches)"
        contact = ""
        website = "https://gitlab.com/dhl0/morphe-patches"
        license = "GPLv3"
    }
}
