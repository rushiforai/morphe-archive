package ee.morphe.patches.shared.misc.gms
...
import ee.morphe.patches.all.manifest.packagename.changePackageNamePatch
import ee.morphe.patches.all.manifest.packagename.setOrGetFallbackPackageName
import ee.morphe.patches.shared.misc.extension.activityOnCreateExtensionHook
import ee.morphe.patches.shared.misc.resources.addAppResources
import ee.morphe.patches.shared.misc.resources.addResourcesPatch
import kotlin.reflect.KFunction1

internal const val EXTENSION_CLASS_DESCRIPTOR = "Lee/morphe/extension/shared/GmsCoreSupport;"
...
fun gmsCoreSupportPatch(
    ...
    execute {
        ...
        earlyReturnFingerprints.forEach {
            it.method.apply {
                if (it.originalMethod.returnType == "Z") {
                    returnEarly(false)
                } else {
                    returnEarly()
                }
