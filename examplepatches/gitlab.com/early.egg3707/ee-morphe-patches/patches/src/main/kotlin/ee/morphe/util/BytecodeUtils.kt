...
/**
 * Overrides the first instruction of a coroutine-style request-result method with
 * a successful boxed `java.lang.Boolean` payload.
 */
fun MutableMethod.returnRequestResultBoxedBooleanEarly(value: Boolean) {
    addInstructions(0,
        """
            new-instance p0, Lp000/hy7${'$'}C8130c;
            sget-object p1, Ljava/lang/Boolean;->${if (value) "TRUE" else "FALSE"}:Ljava/lang/Boolean;
            invoke-direct {p0, p1}, Lp000/hy7${'$'}C8130c;-><init>(Ljava/lang/Object;)V
            return-object p0
        """.trimIndent())
}
...
/**
 * Overrides the first instruction of a coroutine-style request-result method with
 * a successful `null` payload.
 */
fun MutableMethod.returnRequestResultNullEarly() {
    addInstructions(0,
        """
            new-instance p0, Lp000/hy7${'$'}C8130c;
            const/4 p1, 0x0
...
/**
 * Overrides the first instruction of a coroutine-style request-result method with
 * a successful `kotlin.Unit` payload.
 */
fun MutableMethod.returnRequestResultUnitEarly() {
    addInstructions(0,
        """
            new-instance p0, Lp000/hy7${'$'}C8130c;
