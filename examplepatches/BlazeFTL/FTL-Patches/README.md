...
<!-- PATCHES_START -->
> **[v1.33.0-dev.2](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.33.0-dev.2)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;18 patches total
<details>
...
| [Universal Remove Ads](#universal-remove-ads) | Stubs known ad SDK entry points and poisons ad-network URL strings across the whole app. |  |
