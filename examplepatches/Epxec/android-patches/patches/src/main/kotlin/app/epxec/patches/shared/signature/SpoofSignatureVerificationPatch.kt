/*
 * Copied from FTL-Patches by BlazeFTL:
 * https://github.com/BlazeFTL/FTL-Patches
 *
 * Original source licensed under the GNU General Public License v3.0.
 */

package app.epxec.patches.shared.signature
...
private const val EXTENSION_CLASS = "Lapp/epxec/extensions/signature/SignatureHookApp;"
...
val spoofSignatureVerificationPatch = bytecodePatch(
    ...
    description = "(Copied from BlazeFTL) Makes the app think its signing certificate is unchanged after Morphe " +
