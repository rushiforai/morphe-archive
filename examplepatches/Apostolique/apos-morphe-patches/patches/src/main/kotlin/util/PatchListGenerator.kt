                ...
                JsonCompatibility(
                    ...
                    targets = compat.targets.map { target ->
                        JsonCompatibility.Target(
                            ...
                            // AppTarget grew this after the patcher this builds
                            // against, which carries version, isExperimental,
                            // minSdk and description and nothing else. The key
                            // is still written, as null, so the file keeps the
                            // shape whatever reads it expects.
                            versionCodes = null,
