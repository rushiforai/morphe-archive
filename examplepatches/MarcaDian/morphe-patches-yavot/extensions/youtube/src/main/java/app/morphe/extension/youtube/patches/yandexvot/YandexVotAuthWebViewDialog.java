...
public class YandexVotAuthWebViewDialog extends Dialog {
    ...
    public YandexVotAuthWebViewDialog(@NonNull Context context, @NonNull OnTokenReceivedListener listener) {
