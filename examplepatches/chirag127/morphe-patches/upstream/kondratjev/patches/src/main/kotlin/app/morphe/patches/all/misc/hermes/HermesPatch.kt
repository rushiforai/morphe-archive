...
import app.morphe.patches.all.misc.util.toInt
...
/**
 * Hermes bytecode bundle patcher with Boyer-Moore byte replacement
 * and SHA-1 footer recalculation (required for bytecode version > 74).
 *
 * Usage:
 * ```
