...
@Suppress("unused")
val stripPackageVerifierPatch = bytecodePatch(
    name = "Strip Package Verifier",
    ...
    val disabled by booleanOption(
        title = "Disabled",
        default = true,
        key = "packageVerifierDisabled",
        description = "Report verifier as disabled or enabled.",
    )
    ...
    execute {
        ...
        classDefForEach { classDef ->
            ...
            for (method in mutableClass.methods) {
                ...
                for ((index, insn) in instructions.withIndex()) {
                    ...
                    if (ref.definingClass != "Landroid/provider/Settings\$Global;") continue
                    ...
                    if (keyValue != "verifier_verify_adb_installs") continue
        ...
        if (patched > 0) logger.info("Stripped package verifier at $patched call site(s)")
        else logger.warning("No verifier_verify_adb_installs reads found. No changes applied.")
    }
}
