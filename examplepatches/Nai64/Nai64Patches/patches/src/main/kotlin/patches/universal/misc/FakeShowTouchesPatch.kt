...
@Suppress("unused")
val fakeShowTouchesPatch = bytecodePatch(
    name = "Fake Show Touches",
    ...
    val enabled by booleanOption(
        ...
        default = false,
        key = "showTouches",
        description = "Report show touches as enabled or disabled.",
    )
    ...
    execute {
        ...
        classDefForEach { classDef ->
            ...
            for (method in mutableClass.methods) {
                ...
                for ((index, insn) in instructions.withIndex()) {
                    ...
                    if (keyValue != "show_touches") continue
        ...
        if (patched > 0) logger.info("Faked show touches at $patched call site(s)")
        else logger.warning("No show_touches reads found. No changes applied.")
    }
}
