...
![Patches](https://img.shields.io/badge/430%20Patches-2ecc71?style=for-the-badge)
...
> [!NOTE]
> Companion to **[Nai's Patches](https://github.com/Nai64/Nai64Patches)**, which ships the 6 Featured patches (Unlock Premium, Free In-app Purchases, No Ads, Ads Free Rewards, Unlimited Currencies, Pairip Bypass). Add both sources to cover everything.
...
Nai's Extra Patches is a set of ready made patches built for the [Morphe](https://github.com/MorpheApp) patcher. Each patch targets a common annoyance found in modern Android apps and games: rewarded ad walls, forced splash screens, license popups, root and integrity detection, and locked in app purchases.
...
| Method | Link |
| :--- | :--- |
| Deep link | [morphe.software/add-source?github=Nai64/Nai64ExtraPatches](https://morphe.software/add-source?github=Nai64/Nai64ExtraPatches) |
| Manual | `https://github.com/Nai64/Nai64ExtraPatches` |
