...
public final class GboardLongPressQuickActions1777Runtime {
    private static final String TAG = "GboardPatches";
    private static final String LOG_PREFIX = "[gboard-long-press-quick-actions-17.7.7] ";

    private static final Map<ClassLoader,
            WeakReference<GboardLongPressQuickActions1777ReflectionHandles>>
    ...
    private GboardLongPressQuickActions1777Runtime() {
    }

    public static GboardLongPressQuickActions1777ReflectionHandles reflectionHandles(
        ...
        synchronized (HANDLES_BY_CLASS_LOADER) {
            WeakReference<GboardLongPressQuickActions1777ReflectionHandles> reference =
                    HANDLES_BY_CLASS_LOADER.get(classLoader);
            GboardLongPressQuickActions1777ReflectionHandles cached =
                    reference == null ? null : reference.get();
            if (cached != null) {
                return cached;
            }
            GboardLongPressQuickActions1777ReflectionHandles created =
                    new GboardLongPressQuickActions1777ReflectionHandles(classLoader);
    ...
    public static Object maybePatchMetadata(Object metadata, View softKeyView) {
        ...
        try {
            ...
            synchronized (PATCHED_METADATA_BY_ORIGINAL) {
                ...
                GboardLongPressQuickActions1777ReflectionHandles handles =
                        reflectionHandles(classLoader);
                Context context = softKeyView == null ? null : softKeyView.getContext();
                GboardLongPressQuickActions1777Policy.QuickAction action =
                        GboardLongPressQuickActions1777Policy.plan(
    ...
    public static boolean maybeHandleInputEvent(
        ...
        try {
            ...
            boolean enabled = GboardLongPressQuickActionsRuntimeSettings.isEnabled();
            boolean quickActionEvent = GboardLongPressQuickActions1777Policy
            ...
            Integer contextMenuAction =
                    GboardLongPressQuickActions1777Policy.contextMenuActionFor(
    ...
    public static void maybeEnsureLongPressScheduled(
        ...
        try {
            ...
            if (!GboardLongPressQuickActions1777Policy.containsAssignedAction(
