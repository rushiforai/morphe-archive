...
public final class GboardLongPressQuickActions1777ReflectionHandles {
    ...
    private static final String EVENT_CLASS = "nbj";
    private static final String INPUT_METHOD_SERVICE_CLASS = "oau";
    private static final String POINTER_TRACKER_CLASS = "pbl";

    private static final int SINGLE_ICON_POPUP_LAYOUT_ATTR_ID = 0x7f04029c;
    ...
    public GboardLongPressQuickActions1777ReflectionHandles(ClassLoader classLoader)
            throws Throwable {
        ...
        softKeyBindMethod = softKeyViewClass.getDeclaredMethod(
                "q", actionSetClass, long.class);
        inputEventMethod = inputMethodServiceClass.getDeclaredMethod("at", eventClass);
    ...
    public Object appendLongPressAction(Context context, Object metadata,
        ...
        Array.set(updatedEntries, existingEntries.length,
                entryConstructor.newInstance(action.actionCode, null, null));
    ...
    private static void validateInputEventBinding(Class<?> owner, Method method) {
        if (!InputMethodService.class.isAssignableFrom(owner)
            ...
            throw new IllegalArgumentException("oau#at(nbj) binding shape mismatch");
        }
    }
