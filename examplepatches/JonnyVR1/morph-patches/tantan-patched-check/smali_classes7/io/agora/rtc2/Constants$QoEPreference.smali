...
.method static constructor <clinit>()V
    ...
    const-string v2, "VIDEO_QOE_PREFERENCE_DELAY_FIRST"

    const/4 v4, 0x2

    invoke-direct {v1, v2, v3, v4}, Lio/agora/rtc2/Constants$QoEPreference;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v2, Lio/agora/rtc2/Constants$QoEPreference;

    const-string v3, "VIDEO_QOE_PREFERENCE_PICTURE_QUALITY_FIRST"

    const/4 v5, 0x3

    invoke-direct {v2, v3, v4, v5}, Lio/agora/rtc2/Constants$QoEPreference;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lio/agora/rtc2/Constants$QoEPreference;->VIDEO_QOE_PREFERENCE_PICTURE_QUALITY_FIRST:Lio/agora/rtc2/Constants$QoEPreference;

    new-instance v3, Lio/agora/rtc2/Constants$QoEPreference;

    const-string v4, "VIDEO_QOE_PREFERENCE_FLUENCY_FIRST"

    const/4 v6, 0x4

    invoke-direct {v3, v4, v5, v6}, Lio/agora/rtc2/Constants$QoEPreference;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lio/agora/rtc2/Constants$QoEPreference;->VIDEO_QOE_PREFERENCE_FLUENCY_FIRST:Lio/agora/rtc2/Constants$QoEPreference;

    filled-new-array {v0, v1, v2, v3}, [Lio/agora/rtc2/Constants$QoEPreference;
