...
# instance fields
.field private final resultTaskCompletionSource:Ll/sni0;
...
# direct methods
.method public constructor <init>(Lcom/google/firebase/installations/Utils;Ll/sni0;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    .line 6
    iput-object p2, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:Ll/sni0;
...
.method public onException(Ljava/lang/Exception;)Z
    ...
    .line 1
    iget-object p0, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:Ll/sni0;
