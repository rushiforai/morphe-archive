...
void main(void)
{
    ...
    // extrude(2-bit)
	highp float usemasktex = floor(data * SHIFT_RIGHT20);
    data -= usemasktex * SHIFT_LEFT20;
    ...
    if(usemasktex < 0.1){
       VSOutColor0  = Color0.bgra;
        ...
        VSOutColor0     = decode_color(vec2(Color0.x,Color0.y));
        maskuv          = vec2(Color0.z,Color0.w);
