...
.method static constructor <clinit>()V
    ...
    const-string v2, "CONNECTION_STATE_DISCONNECTED"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v2, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;

    const-string v3, "CONNECTION_STATE_CONNECTING"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;->CONNECTION_STATE_CONNECTING:Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;
    ...
    invoke-direct {v3, v4, v5, v5}, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;->CONNECTION_STATE_CONNECTED:Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;

    new-instance v4, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;

    const-string v5, "CONNECTION_STATE_RECONNECTING"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6, v6}, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;->CONNECTION_STATE_RECONNECTING:Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;

    new-instance v5, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;

    const-string v6, "CONNECTION_STATE_FAILED"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7, v7}, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;->CONNECTION_STATE_FAILED:Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;

    filled-new-array/range {v0 .. v5}, [Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;

    move-result-object v0

    sput-object v0, Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;->$VALUES:[Lio/agora/rtc2/RtcConnection$CONNECTION_STATE_TYPE;
