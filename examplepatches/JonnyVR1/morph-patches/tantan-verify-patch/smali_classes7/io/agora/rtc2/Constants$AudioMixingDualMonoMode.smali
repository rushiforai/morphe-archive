...
.method static constructor <clinit>()V
    ...
    const-string v2, "AUDIO_MIXING_DUAL_MONO_L"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v2, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;

    const-string v3, "AUDIO_MIXING_DUAL_MONO_R"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;->AUDIO_MIXING_DUAL_MONO_R:Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;

    new-instance v3, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;

    const-string v4, "AUDIO_MIXING_DUAL_MONO_MIX"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5, v5}, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;->AUDIO_MIXING_DUAL_MONO_MIX:Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;

    filled-new-array {v0, v1, v2, v3}, [Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;

    move-result-object v0

    sput-object v0, Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;->$VALUES:[Lio/agora/rtc2/Constants$AudioMixingDualMonoMode;
